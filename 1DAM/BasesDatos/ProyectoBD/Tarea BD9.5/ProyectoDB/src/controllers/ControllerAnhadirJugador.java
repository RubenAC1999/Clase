...
public class ControllerAnhadirJugador {
    ...
    /* Tiene que tener mínimo 16 años */
    ...
    /* El dorsal tiene que ser del 1 al 99 */
    ...
    private void handleBtnConfirmar(ActionEvent event) {
        ...
        try {
            ...
            basedatos.insertarNuevoJugador(jugadorCreado);
            labelMensaje.setText("Jugador añadido correctamente");
            ...
            if (e.getErrorCode() == 1062) {
                ...
                labelMensaje.setText("Error al añadir el jugador: " + e.getMessage());
                labelMensaje.setStyle("-fx-text-fill: red;");
            }
        }
    }
